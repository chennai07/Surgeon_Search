    ...
    try {
      ...
      final response = await _postWithRetry(
        ...
        body: jsonEncode({
          ...
          'type': selectedRole, // Send selected role
        }),
      );
      ...
      if (response.statusCode == 200) {
        ...
        // Navigation logic (simplified for redirection, standardizing on surgeon for now)
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // 🔹 Role Selection (Only used for first-time Google Sign-In)
                  const Text(
